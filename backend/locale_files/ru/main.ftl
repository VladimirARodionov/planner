...
task-edit-error-date-format = Ошибка формата даты: пожалуйста, используйте правильный формат (ДД.ММ.ГГГГ или ДД.ММ.ГГГГ ЧЧ:ММ)
...
settings_timezone_help = /timezone Изменить часовой пояс
